...
The Slim.io project has a [Code of Conduct](./CODE_OF_CONDUCT.md) that *all* contributors are
expected to follow. This code describes the *minimum* behavior expectations
for all contributors.

As a contributor to Slim.io, how you choose to act and interact towards your
...
All contributors to Slim.io tacitly agree to abide by both the letter and
